...
NIKE_HOME_URL = "https://www.nike.com/il/login"
...
def run(driver, shoe_type, username, password, url, shoe_size, shipping_option, login_time=None, release_time=None,
    ...
    if release_time:
        ...
        wait_duration = (date_parser.parse(release_time) - datetime.datetime.now()).total_seconds()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--page-load-timeout", type=int, default=3)
    ...
    parser.add_argument("--shoe-type", default="EU", choices=("M", "W", "Y", "C", "XXS", "XS", "S", "L", "XL", "EU"))
